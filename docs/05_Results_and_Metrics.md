...
|---------|--------------|--------|
| **Total Members** | Combined user count across all regions | ~45,000 |
| **Active Moderators** | Number of trained staff with limited elevated permissions | ~20 |
| **Contributors / Spawners** | Verified community event coordinators | 400-600 active |
| **Average Monthly Messages** | Total activity across all text channels | 85,000–100,000 |
| **Peak Monthly Messages (Jul 2024)** | Record month of community activity | 115,360 |
| **Bot Commands Executed (Monthly Avg.)** | Tempo-Bot and moderation tools combined | ~6,000 |
| **Security Alerts Processed (2025)** | Automated detections handled by regex and filters | 84 |
...
- **Standardized documentation** cut onboarding time for new moderators and contributors from months to weeks.  
- **Consistent security automation** has maintained **zero major spam or phishing incidents** since implementation.  
...
- Authored and maintained over **six structured operational guides**:
  ...
  - *Governance & Promotions Policy*
- Documentation updates tracked via GitHub repositories and Discord logs to maintain transparency and version history.  
...
- Fostered a **positive, cooperative culture** across multiple data centers and partner communities.  
